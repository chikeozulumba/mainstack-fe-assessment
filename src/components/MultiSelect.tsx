...
const MultiSelectTrigger = ({
  ...
  return (
    <button
      className={cn(
        'sm:px-[16px] sm:py-[16px] px-[8px] relative w-full flex items-center justify-between h-[48px] rounded-[12px] border-[3px] text-[#131316] text-left pr-[32px] text-[14px] font-[500] leading-[16px] tracking-[-0.2px] content-center align-middle',
